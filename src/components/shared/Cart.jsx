...
export const Cart = (props) => {
  ...
  return (
    <div className={`lg:col-span-2  fixed   top-0 bg-[#1F1D2B] w-full h-full lg:right-0 lg:w-96 transition-all z-50 ${showOrder ? "right-0" : "-right-full"}`}> {/*quite el w-full*/}
          {/* Orders */}
          <div className="relative  pt-16 p-8 lg:pt-8 text-gray-300 h-full overflow-scrol pb-96">
            <RiCloseLine onClick={()=> setShowOrder(false)} 
            className="lg:hidden absolute  p-3 box-content text-gray-400 bg-[#262837] rounded-full left-4 top-4 text-xl" />
